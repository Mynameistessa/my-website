...
export const ExpandedCVRow = ({
  ...
  return (
    <div>
      ...
      <div
        className={`description-${index} dark:text-white text-neutral-900 px-8 py-4 text-m max-w-200 break-words`}
      >
...
export const CVSmallRow = ({
  ...
  return (
    <>
      ...
      <div
        className={`dark:text-white text-neutral-900 px-8 py-2 lg:text-m text-sm max-w-200 break-words`}
      >
